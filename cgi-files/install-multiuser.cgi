...
#################################################################################
	...
	my $xestiascan_config_dbmodule_filename = xestiascan_variablecheck($main::xestiascan_config{"system_authmodule"}, "module", 0, 1);
	...
	my $xestiascan_config_dbmodule_fileexists = xestiascan_fileexists("Modules/Database/" . $main::xestiascan_config{"system_authmodule"} . ".pm");
	...
	my $xestiascan_config_dbmodule_permissions = xestiascan_filepermissions("Modules/Database/" . $main::xestiascan_config{"system_dbmodule"} . ".pm", 1, 0);
...
if ($http_query_confirm eq 1){
	...
	# TODO: Check if password value is blank and load settings files
	# if this is the case.
...
if (xestiascan_settings_load ne 0){
	...
	$default_dbmodule	= $xestiascan_config{system_dbmodule};
